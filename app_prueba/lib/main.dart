import 'dart:convert';
import 'package:app_prueba/screens/result_screen.dart';
import 'package:flutter/material.dart';
import 'screens/menu.dart';
import 'package:mysql_client/mysql_client.dart';
import 'package:http/http.dart' as http;
import 'package:provider/provider.dart';
import 'screens/imc_model.dart';

void main() {
  runApp(
    ChangeNotifierProvider(
      create: (context) => IMCModel(),
      child: Miapp(),
    ),
  );
}
            ...
            children: [
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(
                    0, 135, 0, 0), //  Padding top de imagen
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(
                      15.0), // Cambia el valor para ajustar el redondeo
                  child: Image.asset(
                    'assets/Logo.png',
                    width: 220,
                    height: 110,
                    fit: BoxFit
                        .cover, // Opcional: ajusta cómo se adapta la imagen
                  ),
                ),
              ),
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(
                      0, 35, 0, 0), //  Padding top del contenedor verde
                  child: Container(
                    width: 280,
                    height: 420,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  30, 35, 30, 10), //  Padding de contraseña
                              child: Text(
                                'Contraseña',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(0, 30, 0,
                                  0), // Padding del boton de iniciar sesion
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
