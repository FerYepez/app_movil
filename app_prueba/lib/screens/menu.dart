    ...
    try {
      ...
      if (heightController.text.isEmpty || weightController.text.isEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Por favor, ingrese datos en ambos campos.'),
          ),
        );
      ...
      final double height =
          double.parse(heightController.text) / 100; // Convertir a metros
      ...
      // Manejar errores de formato (e.g., texto no convertible a número)
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                // Navegar a la pantalla de recetas vegetarianas
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RecipeGrid(
                      category: 'Vegetarian', // Categoría para la consulta
                      categoryTitle: 'Recetas vegetarianas', // Título dinámico
                    ),
                  ),
                );
              },
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => RecipeGrid(
                      category: 'vegan', // Categoría para la consulta
                      categoryTitle: 'Recetas veganas', // Título dinámico
                    ),
                  ),
                );
              },
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => RecipeGrid(
                      category: 'breakfast', // Categoría para la consulta
                      categoryTitle: 'Desayunos', // Título dinámico
                    ),
                  ),
                );
              },
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => RecipeGrid(
                      category: 'starter', // Categoría para la consulta
                      categoryTitle:
                          'Recetas para principiantes', // Título dinámico
                    ),
                  ),
                );
              },
